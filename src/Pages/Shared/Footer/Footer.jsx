...
const Footer = () => {
  return (
    <footer className="footer  p-10 bg-emerald-700 text-white">
      <nav>
        <header className="footer-title">ERA-Housing Real-Estate</header>

        <Link to="https://www.era.pt/comprar/moradias/porto?ob=1&tp=2&lc=13-12&page=1&ord=3">
          {" "}
      ...
      <nav>
        <header className="footer-title text-white font-bold text-xl">
          All Social Link
        </header>
        <div className="grid grid-flow-col text-2xl gap-4">
          <Link to="https://www.facebook.com/eraimobiliaria/?locale=pt_PT">
            {" "}
            <FaFacebookF></FaFacebookF>{" "}
          </Link>

          <Link to="https://www.google.com/search?q=era+imobili%C3%A1ria&sca_esv=587361146&sxsrf=AM9HkKkBcLIuwxJZoG4Tx-GqIZlfPSUCpw%3A1701561239638&ei=l8NrZYDLJpq69u8P4Y6QgAs&ved=0ahUKEwjA8oHK-fGCAxUanf0HHWEHBLAQ4dUDCBA&oq=era+imobili%C3%A1ria&gs_lp=Egxnd3Mtd2l6LXNlcnAiEGVyYSBpbW9iaWxpw6FyaWFIAFAAWABwAHgBkAEAmAEAoAEAqgEAuAEMyAEA4gMEGAAgQQ&sclient=gws-wiz-serp">
            <FaGoogle></FaGoogle>{" "}
          </Link>
